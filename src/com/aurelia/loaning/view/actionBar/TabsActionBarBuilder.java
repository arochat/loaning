...
public class TabsActionBarBuilder implements ActionBarBuilder {

	private ActionBar actionBar;

	public TabsActionBarBuilder(Map<Integer, ActionBarItem> actionBarDefinition, TabListener tabListener,
			ActionBar actionBar) {
		ActionBarItem item;
